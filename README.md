Co-operative co-founder and associate worker at [yaal.coop](https://yaal.coop) and [lasuite.coop](https://lasuite.coop). Building authentication and provisioning tools for Python. Developer for almost 20 years.
...
- Jinja: [jinja-autodoc](https://github.com/sphinx-contrib/jinja-autodoc)
- Pytest: [pytest-libfaketime](https://github.com/pytest-dev/pytest-libfaketime) and [pytest-scim2-server](https://github.com/pytest-dev/pytest-scim2-server)
